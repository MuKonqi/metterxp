...
if os.path.isfile(lang_en):
    ...
    button2=Button(window, font="arial 12 bold", cursor="hand2", activeforeground=a_button_fg, activebackground=a_button_bg, background=a_button_bg, foreground=a_button_fg, text="Version: 2.0-x Beta", command=version)
    ...
    space2=Label(window, background=bg, foreground=fg, text="\n", font="arial 1")
    button2=Button(window, font="arial 12 bold", cursor="hand2", activeforeground=a_button_fg, activebackground=a_button_bg, background=a_button_bg, foreground=a_button_fg, text="Sürüm: 2.0-x Beta", command=version)
