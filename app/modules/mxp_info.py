...
if os.path.isfile(lang_en):
    ...
    button2=Button(window, font="arial 12 bold", cursor="hand2", activeforeground=a_button_fg, activebackground=a_button_bg, background=a_button_bg, foreground=a_button_fg, text="Version: 2.2.1-withfixes", command=version)
    ...
    button6=Button(window, font="arial 12 bold", cursor="hand2", activeforeground=a_button_fg, activebackground=a_button_bg, background=a_button_bg, foreground=a_button_fg, text="Developer: MuKonqi (Muhammed Abdurrahman)", command=developer)
    ...
    space2=Label(window, background=bg, foreground=fg, text="\n", font="arial 1")
    button2=Button(window, font="arial 12 bold", cursor="hand2", activeforeground=a_button_fg, activebackground=a_button_bg, background=a_button_bg, foreground=a_button_fg, text="Sürüm: 2.2.1-withfixes", command=version)
    ...
    button6=Button(window, font="arial 12 bold", cursor="hand2", activeforeground=a_button_fg, activebackground=a_button_bg, background=a_button_bg, foreground=a_button_fg, text="Geliştirici: MuKonqi (Muhammed Abdurrahman)", command=developer)
    space3=Label(window, background=bg, foreground=fg, text="\n", font="arial 3")
