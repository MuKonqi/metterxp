...
os.system(" mv /usr/local/bin/metterxp-beta/metterxp/app/metterxp.py /usr/bin/metterxp")
os.system(" mv /usr/local/bin/metterxp-beta/metterxp/app/python3.policy /usr/share/polkit-1/actions/")
os.system(" mv /usr/local/bin/metterxp-beta/metterxp/app/metterxp.desktop /usr/share/applications")
os.system(" mv /usr/local/bin/metterxp-beta/metterxp/app/unsupported.app /usr/local/bin/metterxp-beta/")
os.system(" mkdir /usr/local/bin/metterxp-beta/modules ; mv /usr/local/bin/metterxp-beta/metterxp/app/modules/* /usr/local/bin/metterxp-beta/modules ;  mv /usr/local/bin/metterxp-beta/metterxp/app/icon.png /usr/local/bin/metterxp-beta/ ;  mv /usr/local/bin/metterxp-beta/metterxp/app/LICENSE /usr/local/bin/metterxp-beta/")
