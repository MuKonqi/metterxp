...
def bash():
    ...
    def main():
        ...
        cmd2=" touch /usr/local/bin/metterxp-beta/.bashrc.bak ;  cp /home/"+str_my_user_name+"/.bashrc /usr/local/bin/metterxp-beta/.bashrc.bak"             
        os.system(cmd2)
        if os.path.isfile("/usr/local/bin/metterxp-beta/.bashrc-first.bak"):
            pass
        else:
            cmd3=" touch /usr/local/bin/metterxp-beta/.bashrc-first.bak ;  cp /home/"+str_my_user_name+"/.bashrc /usr/local/bin/metterxp-beta/.bashrc-first.bak"
            os.system(cmd3)   
        ...
        def reset():
            ...
            def initialstatebash():
                _cmd2=" cp /usr/local/bin/metterxp-beta/.bashrc.bak /home/"+str_my_user_name+"/.bashrc"
                os.system(_cmd2)
                if os.path.isfile(lang_en):
            ...
            def firststatebash():
                _cmd3=" cp /usr/local/bin/metterxp-beta/.bashrc-first.bak /home/"+str_my_user_name+"/.bashrc"
                os.system(_cmd3)
                if os.path.isfile(lang_en):
                    messagebox.showinfo("Information","Succesful! All changes are undone.")
                elif os.path.isfile(lang_tr):
