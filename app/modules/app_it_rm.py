...
def flatpak():
    def flatpak_main():
        def f_packageit():
            ...
            if os.path.isfile(lang_en):
                ...
                text7=Label(window_2, background="#000000", foreground="#FFFFFF", font="arial 12", text="\nInformation: If the package name you entered is not incorrect, the process has been completed successfully! \n\nNote: Changing the command output below does not change anything.\n")
                text8=Text(window_2, yscrollcommand=scroll.set)
                text8.insert(END, out)
                scroll.config(command=text8.yview)
                space10=Label(window_2, background="#000000", foreground="#FFFFFF", text="\n", font="arial 3")
                button_7=Button(window_2, cursor="hand2", activebackground="#03035B", activeforeground="#FFFFFF", background="#FFFFFF", foreground="#000000", borderwidth="3", text="Close window", command=window_2.destroy)
            elif os.path.isfile(lang_tr):
                window_2=Toplevel()
                ...
                scroll.config(command=text8.yview)
                space10=Label(window_2, background="#000000", foreground="#FFFFFF", text="\n", font="arial 3")
                button_7=Button(window_2, cursor="hand2", activebackground="#03035B", activeforeground="#FFFFFF", background="#FFFFFF", foreground="#000000", borderwidth="3", text="Pencereyi kapat", command=window_2.destroy)
    ...
    if os.path.isfile("/usr/bin/flatpak") or os.path.isfile("/bin/flatpak:"):
        ...
        window.destroy()
        os.system("pkexec python3 /usr/local/bin/metterxp-beta/modules/pm_it.py")
        flatpak_main()
def other():
    def packageit():
        if os.path.isfile(debian):
        ...
        if os.path.isfile(lang_en):
            ...
            window_2.resizable(0, 0)
            scroll=Scrollbar(window_2)
            text3=Label(window_2, background="#000000", foreground="#FFFFFF", font="arial 12", text="\nInformation: If the package name you entered is not incorrect, the process has been completed successfully!\n\nNote: Changing the output of the command below will not change anything.\n")
            text4=Text(window_2, yscrollcommand=scroll.set)
            text4.insert(END, out)
            scroll.config(command=text4.yview)
            space6=Label(window_2, background="#000000", foreground="#FFFFFF", text="\n", font="arial 3")
            button_6=Button(window_2, cursor="hand2", activebackground="#03035B", activeforeground="#FFFFFF", background="#FFFFFF", foreground="#000000", borderwidth="3", text="Close window", command=window_2.destroy)
        elif os.path.isfile(lang_tr):
            window_2=Toplevel()
            window_2.title("Çıktı | MetterXP")
            window_2.config(background="#000000")
            ...
            scroll.config(command=text4.yview)
            space6=Label(window_2, background="#000000", foreground="#FFFFFF", text="\n", font="arial 3")
            button_6=Button(window_2, cursor="hand2", activebackground="#03035B", activeforeground="#FFFFFF", background="#FFFFFF", foreground="#000000", borderwidth="3", text="Pencereyi kapat", command=window_2.destroy)
        scroll.pack(side=RIGHT,fill=Y)
        text3.pack()
        text4.pack()
        space6.pack()
    ...
    def packagerm():
        ...
        button_6.pack()
    if os.path.isfile(lang_en):
        text2=Label(window, background=bg, foreground=fg, font="arial 10 bold", text="Please enter the name of the program/package you want to uninstall or install.\nNote: You must enter the package name correctly!")
        ...
        text2=Label(window, background=bg, foreground=fg, font="arial 10 bold", text="Lütfen kaldırmak ya da kurmak istediğiniz programın/paketin adını giriniz.\nNot: Paket adını doğru girmeniz gerekmektedir!")
        space4=Label(window, background=bg, foreground=fg, text="\n", font="arial 3")
        packagename=Entry(window)
