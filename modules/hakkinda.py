...
buton5.pack()
buton6=Button(pencere, font="arial 12 bold", cursor="hand2", activeforeground="#0099FF", activebackground="#000000", background="#000000", foreground="#FFFFFF", text="Sürüm: 1.0-1", command=surum)
buton6.pack()
