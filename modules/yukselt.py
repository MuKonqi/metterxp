...
os.system("sudo mv /usr/local/bin/metterxp/modules /usr/local/bin/metterxp ; sudo /usr/local/bin/metterxp/metterxp/icon.png /usr/local/bin/metterxp ; sudo /usr/local/bin/metterxp/metterxp/LICENSE /usr/local/bin/metterxp")
exit()