...
if "--yukseltiyukselt" in args:
    ...
    os.system(" cp /usr/local/bin/metterxp/metterxp/modules/yukselt.py /usr/local/bin/metterxp/modules")
...
os.system(" mv /usr/local/bin/metterxp/metterxp/unsupported.app /usr/local/bin/metterxp")
os.system(" mkdir /usr/local/bin/metterxp/modules ; mkdir  mv /usr/local/bin/metterxp/metterxp/modules/* /usr/local/bin/metterxp/modules ;  mv /usr/local/bin/metterxp/metterxp/icon.png /usr/local/bin/metterxp ;  mv /usr/local/bin/metterxp/metterxp/LICENSE /usr/local/bin/metterxp")
