...
def dekurucu():
    ...
    islemsecimbuton2.config(text="GNOME DE'ı kur",command=gnomekur)   
    islemsecimbuton3.config(text="Mate DE'ı kur",command=matekur)
    islemsecimbuton4.config(text="Budgie DE'ı kur",command=budgiekur)    
...
def desilici():
    ...
    islemsecimbuton2.config(text="GNOME DE'ı kaldır",command=gnomesil)   
    islemsecimbuton3.config(text="Mate DE'ı kaldır",command=matesil)
    islemsecimbuton4.config(text="Budgie DE'ı kaldır",command=budgiesil)    
    islemsecimbuton5.destroy()
    islemsecimbuton6.destroy()
    islemsecimbuton7.destroy()
    islemsecimbuton8.destroy()
...
def firefoxkur():
    try:
        ...
        os.system("sudo eopkg it firefox -y")
...
def bravekur():
    try:
        print("\nBrave kurulumu başlatılıyor...")
        os.system("sudo eopkg it brave -y")
        messagebox.showinfo("Bilgilendirme","Brave internet tarayıcısı başarıyla kuruldu.")
    except:
        messagebox.showerror("Hata","Bazı hata(lar) oluştu!\n'OK' tuşuna basınca tekrar denemeniz için program kapatılacak.")
        programkapat()
def plankkur():
    try:
        ...
        os.system("sudo eopkg it plank -y")
...
def gpartedkur():
    try:
        ...
        os.system("sudo eopkg it gparted -y")
...
def gimpkur():
    try:
        ...
        os.system("sudo eopkg it gimp -y")
...
def cupskur():
    try:
        ...
        os.system("sudo eopkg it cups -y")
...
def terminatorkur():
    try:
        ...
        os.system("sudo eopkg it terminator -y")
...
def codeblockskur():
    try:
        ...
        os.system("sudo eopkg it codeblocks -y")
...
def playonlinuxkur():
    try:
        ...
        os.system("sudo eopkg it playonlinux -y")
...
def winekur():
    try:
        ...
        os.system("sudo eopkg it wine -y")
...
def firefoxsil():
    try:
        ...
        os.system("sudo eopkg rm firefox -y")
...
def bravesil():
    try:
        print("\nBrave kaldırılıyor...")
        os.system("sudo eopkg rm brave -y")
        messagebox.showinfo("Bilgilendirme","Brave internet tarayıcısı başarıyla kaldırıldı.")
    except:
        messagebox.showerror("Hata","Bazı hata(lar) oluştu!\n'OK' tuşuna basınca tekrar denemeniz için program kapatılacak.")
        programkapat()
def planksil():
    try:
        print("\nPlank kaldırılıyor...")
        os.system("sudo eopkg rm plank -y")
...
def gpartedsil():
    try:
        ...
        os.system("sudo eopkg rm gparted -y")
...
def gimpsil():
    try:
        print("\nGIMP kaldırılıyor...")
        os.system("sudo eopkg rm gimp -y")
...
def cupssil():
    try:
        print("\nCups kaldırılıyor...")
        os.system("sudo eopkg rm cups -y")
...
def terminatorsil():
    try:
        ...
        os.system("sudo eopkg rm terminator -y")
...
def codeblockssil():
    try:
        ...
        os.system("sudo eopkg rm codeblocks -y")
...
def playonlinuxsil():
    try:
        ...
        os.system("sudo eopkg rm playonlinux -y")
...
def winesil():
    try:
        print("\nWine kaldırılıyor...")
        os.system("sudo eopkg rm wine -y")
...
def zorincopy():
    try:
        ...
        programkapat()
def rootuyg():
    yazi2.config(text="Lütfen açmak istediğiniz uygulamayı seçiniz.\nNot: Uygulamaları bu şekilde açıp, sistem ve uygulamalar için gerekli dosyaları SİLERSENİZ veya DEĞİŞTİRİRSENİZ sisteminiz ile uygulamalar HASAR ALABİLİR. Lütfen dikkatli olunuz!")
    islemsecimbuton1.config(text="Nautilus'u bu şekilde aç",command=nautilusopen)
    islemsecimbuton2.config(text="Nautilus'u kur sonra bu şekilde aç",command=nautilusstart)
    islemsecimbuton3.config(text="Caja'yı bu şekilde aç",command=cajaopen)
    islemsecimbuton4.config(text="Caja'yı kur sonra bu şekilde aç",command=cajastart)
    islemsecimbuton5.destroy()
    islemsecimbuton6.destroy()
    islemsecimbuton7.destroy()
    islemsecimbuton8.destroy()
...
def nautilusstart():
    try:
        print("\nNautilus kuruluyor...")
        os.system("sudo eopkg it nautilus -y")
        print("\nNautilus açılıyor...")
        os.system("sudo nautilus")
        messagebox.showinfo("Bilgilendirme","İşlem tamamlandı.")
    except:
...
def cajastart():
    try:
        print("\nCaja kuruluyor...")
        os.system("sudo eopkg it caja -y")
        print("\nCaja açılıyor...")
        os.system("sudo caja")
        messagebox.showinfo("Bilgilendirme","İşlem tamamlandı.")
    except:
...
def flatpakkur():
    try:
        print("\nFlatpak kuruluyor...")
        os.system("sudo eopkg it flatpak xdg-desktop-portal-gtk -y")
...
def snapkur():
    try:
        print("\nSnap kuruluyor...")
        os.system("sudo eopkg it snapd -y")
...
def bxpup():
    try:
        ...
        os.system("sudo cp -r /usr/local/bin/BetterXP/BetterXP_Solus/up.py /usr/local/bin/BetterXP")
...
def grubc():
    try:
        ...
        os.system("sudo eopkg it grub-customizer -y")
...
def temizle():
    try:
        os.system("sudo eopkg dc && sudo eopkg clean")
        messagebox.showinfo("Bilgilendirme","Önbellek ile kullanılmayan kilitler temizlendi.")
    except:
        messagebox.showerror("Hata","Bazı hata(lar) oluştu!\n'OK' tuşuna basınca tekrar denemeniz için program kapatılacak.")
        programkapat()
def islemsecim():
    ...
    islemsecimbuton10.config(text="Önbellek ile kullanılmayan kilitleri temizle",command=temizle)
